...
data class BusinessOperation(
    ...
    companion object {
        ...
        const val TYPE_TAX = "TAX"
        const val TYPE_COMMISSION = "COMMISSION"
        const val TYPE_OTHER_INCOME = "OTHER_INCOME"
        const val TYPE_OTHER_EXPENSE = "OTHER_EXPENSE"
        const val TYPE_PENALTY_ACCRUAL = "PENALTY_ACCRUAL"
        const val TYPE_PENALTY_PAYMENT = "PENALTY_PAYMENT"
        const val TYPE_DEPOSIT_RECEIVED = "DEPOSIT_RECEIVED"
        const val TYPE_DEPOSIT_REFUNDED = "DEPOSIT_REFUNDED"
        const val TYPE_DISCOUNT = "DISCOUNT"
        const val TYPE_DEBT_FORGIVEN = "DEBT_FORGIVEN"
